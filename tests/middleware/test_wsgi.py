...
def wsgi_middleware(request: pytest.FixtureRequest) -> Callable[..., object]:
    params = [wsgi._WSGIMiddleware, a2wsgi.WSGIMiddleware]
    return request.param  # Ensure types are treated as objects
